...
const DURATIONS = [
  { months: 1, deliveries: 4, label: '1 Month', desc: '4 Drops Contract' },
  { months: 2, deliveries: 8, label: '2 Months', desc: '8 Drops Contract', popular: true },
  { months: 3, deliveries: 12, label: '3 Months', desc: '12 Drops Contract' },
];
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-500">
                ₹{pricePerUnit.toFixed(2)} / {product.unit} · Choose order type
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-5 overflow-y-auto space-y-4 flex-1 text-xs">
          <div className="space-y-3">
            ...
            {/* Option 2: Recurring Order (Bulk Contract) */}
            <div 
            ...
            >
              <div className="flex items-start gap-3.5">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-slate-500 text-[11px] mt-0.5">
                    Order repeated deliveries from the same farmer for 1, 2, or 3 months on a scheduled day &amp; time.
                  </p>
                </div>
              </div>
          ...
          >
            {selectedType === 'subscription' ? (
              <>
                ...
                Confirm &amp; Start Recurring Contract
              </>
            ) : (
              <>
