...
import { Sprout, Users, ArrowRight, ShieldCheck, TrendingUp, HandCoins, Truck, Sparkles, CheckCircle2, Play, Pause, Volume2, VolumeX, ArrowUpRight, Zap } from 'lucide-react';
...
const Landing = () => {
  ...
  return (
    <div className="space-y-20 bg-[#f7fbf8] pb-24 text-slate-900 overflow-hidden selection:bg-emerald-500 selection:text-white">
      
      {/* ── Dynamic Hero Section (Video + Glass Overlays) ── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-emerald-50/80 to-teal-50 text-slate-900 pt-28 pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8 border-b border-emerald-100">
        {/* Dynamic ambient particles / glow */}
        <div className="absolute inset-0 opacity-40 bg-[linear-gradient(rgba(16,185,129,0.08)_1px,transparent_1px),linear-gradient(90deg,rgba(16,185,129,0.08)_1px,transparent_1px)] [background-size:24px_24px] pointer-events-none"></div>
        <div className="absolute top-1/4 right-1/4 w-[480px] h-[480px] rounded-full bg-emerald-200/35 blur-[130px] pointer-events-none"></div>
        <div className="absolute bottom-1/4 left-1/4 w-[360px] h-[360px] rounded-full bg-amber-200/30 blur-[110px] pointer-events-none"></div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-emerald-100 text-emerald-800 border border-emerald-200 backdrop-blur-md shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <Link
                to="/marketplace"
                className="bg-white/75 hover:bg-white text-slate-800 border border-emerald-200 font-bold text-base px-8 py-4 rounded-2xl transition-all text-center flex items-center justify-center gap-2 hover:border-emerald-400 active:scale-95 shadow-sm"
              >
            ...
            <div className="flex flex-wrap gap-4 pt-3 text-xs font-semibold text-slate-600">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="h-4 w-4 text-emerald-600" /> Real-Time Mandi Benchmark
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="h-4 w-4 text-emerald-600" /> Direct Escrow Payouts
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="h-4 w-4 text-emerald-600" /> Pincode-Optimized Logistics
              </span>
            </div>
          </motion.div>
          ...
          {stats.map((s, index) => {
            ...
            return (
              <motion.div 
                key={index}
                variants={fadeInUp}
                className="bg-white border border-slate-100 p-6 rounded-3xl shadow-sm hover:shadow-md transition-all flex items-center gap-4 card-hover-3d"
              >
                <div className={`p-3.5 rounded-2xl border ${s.color}`}>
                  <Icon className="h-6 w-6" />
                </div>
                <div>
                  <div className="text-2xl font-display font-black text-slate-900 tracking-tight">{s.value}</div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        >
          ...
          <div className="space-y-4 pt-2">
            <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-white border border-slate-100 shadow-xs">
              <ShieldCheck className="h-6 w-6 text-emerald-600 shrink-0 mt-0.5" />
              <div>
                <h4 className="font-bold text-slate-800 text-sm">Strict KYC & Land Document Verification</h4>
                <p className="text-slate-500 text-xs mt-1 leading-normal">Every listing is verified by platform admins checking FPO certificates, 7/12 land records, and crop authenticity.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-white border border-slate-100 shadow-xs">
              ...
              <div>
                ...
                <p className="text-slate-500 text-xs mt-1 leading-normal">Orders are auto-assigned to regional driver partners, reducing transit food mileage and transit spoilage.</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="lg:col-span-7 bg-white border border-slate-100 p-6 sm:p-8 rounded-3xl shadow-sm"
        >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div 
            variants={fadeInUp}
            className="bg-white border border-slate-100 rounded-3xl p-7 shadow-xs flex flex-col hover:border-emerald-500/40 transition-all card-hover-3d"
          >
            <div className="h-10 w-10 rounded-2xl bg-emerald-500/10 text-emerald-600 flex items-center justify-center font-bold text-lg mb-5 border border-emerald-500/20">
              🌾
            </div>
            <span className="text-[11px] font-extrabold uppercase tracking-wider text-emerald-600 bg-emerald-500/10 self-start px-2.5 py-1 rounded-full mb-3">Farmer / FPO Role</span>
            <h3 className="font-display font-bold text-xl text-slate-800 mb-2">Maximize Listing Earnings</h3>
            ...
            <Link to="/register?role=farmer" className="text-xs font-bold text-emerald-600 hover:text-emerald-700 flex items-center gap-1.5 mt-auto pt-4 border-t border-slate-100">
          ...
          <motion.div 
            variants={fadeInUp}
            className="bg-white border border-slate-100 rounded-3xl p-7 shadow-xs flex flex-col hover:border-amber-500/40 transition-all card-hover-3d"
          >
            <div className="h-10 w-10 rounded-2xl bg-amber-500/10 text-amber-600 flex items-center justify-center font-bold text-lg mb-5 border border-amber-500/20">
              🛒
            </div>
            <span className="text-[11px] font-extrabold uppercase tracking-wider text-amber-600 bg-amber-500/10 self-start px-2.5 py-1 rounded-full mb-3">Retail Consumer</span>
            <h3 className="font-display font-bold text-xl text-slate-800 mb-2">Buy Fresh, Direct Farm Produce</h3>
            <p className="text-slate-500 text-xs leading-relaxed mb-6">
            ...
            <Link to="/register?role=consumer" className="text-xs font-bold text-amber-600 hover:text-amber-700 flex items-center gap-1.5 mt-auto pt-4 border-t border-slate-100">
          ...
          <motion.div 
            variants={fadeInUp}
            className="bg-white border border-slate-100 rounded-3xl p-7 shadow-xs flex flex-col hover:border-cyan-500/40 transition-all card-hover-3d"
          >
            <div className="h-10 w-10 rounded-2xl bg-cyan-500/10 text-cyan-600 flex items-center justify-center font-bold text-lg mb-5 border border-cyan-500/20">
              🏢
            </div>
            <span className="text-[11px] font-extrabold uppercase tracking-wider text-cyan-600 bg-cyan-500/10 self-start px-2.5 py-1 rounded-full mb-3">Bulk Industry Partner</span>
            <h3 className="font-display font-bold text-xl text-slate-800 mb-2">Request Tiered Wholesale Quotes</h3>
            <p className="text-slate-500 text-xs leading-relaxed mb-6">
            ...
            <Link to="/register?role=bulk_buyer" className="text-xs font-bold text-cyan-600 hover:text-cyan-700 flex items-center gap-1.5 mt-auto pt-4 border-t border-slate-100">
